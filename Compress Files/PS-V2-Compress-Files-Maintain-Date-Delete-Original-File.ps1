function CompressFiles {
    <#
    .SYNOPSIS
        Made for PowerShell Version 2.0
    ...
    Get-ChildItem $SourceFolder -Recurse:$Recurse | Where-Object { !$_.PSIsContainer } |
    ...
    Where-Object { $_.LastWriteTime -lt $refDate } | select * |
        ...
        Set-ItemProperty -Path $Target -Name CreationTime -Value $CreationTime
        Set-ItemProperty -Path $Target -Name LastWriteTime -Value $LastWriteTime
        Set-ItemProperty -Path $Target -Name LastAccessTime -Value $LastAcessTime
